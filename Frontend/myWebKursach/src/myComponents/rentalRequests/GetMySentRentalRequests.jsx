...
import { getMySentRentalRequests } from "@/services/rentalRequests/getMySentRentalRequests";

export default function GetMySentRentalRequests() {
  ...
  const fetchData = async () => {
    try {
      const rentalRequestsData = await getMySentRentalRequests(page);
  ...
  const handlePageChange = (newPage) => {
    setPage(newPage);
    navigate(`/mySentRentalRequests/${newPage}`);  // переход по маршруту с номером страницы
  };
