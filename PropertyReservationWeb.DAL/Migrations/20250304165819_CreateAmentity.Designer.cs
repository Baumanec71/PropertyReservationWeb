...
namespace PropertyReservationWeb.DAL.Migrations
{
    ...
    [Migration("20250304165819_CreateAmentity")]
    partial class CreateAmentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Balans = 0,
                            DateOfRegistration = new DateTime(2025, 3, 4, 16, 58, 18, 422, DateTimeKind.Utc).AddTicks(1676),
