...
namespace PropertyReservationWeb.DAL.Migrations
{
    ...
    [Migration("20250410171528_UpdateModelsRentals")]
    partial class UpdateModelsRentals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 0m,
                            BonusPoints = 100000m,
                            DateOfRegistration = new DateTime(2025, 4, 10, 17, 15, 27, 950, DateTimeKind.Utc).AddTicks(5764),
