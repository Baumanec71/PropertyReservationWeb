...
namespace PropertyReservationWeb.DAL.Migrations
{
    ...
    [Migration("20250329111306_UpdateModels2.0")]
    partial class UpdateModels20
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.RentalRequest", b =>
                {
                    ...
                    b.Property<long?>("PaymentActiveId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 0m,
                            BonusPoints = 100000,
                            DateOfRegistration = new DateTime(2025, 3, 29, 11, 13, 5, 996, DateTimeKind.Utc).AddTicks(2924),
