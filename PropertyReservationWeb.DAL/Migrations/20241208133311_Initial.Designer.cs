...
namespace PropertyReservationWeb.DAL.Migrations
{
    ...
    [Migration("20241208133311_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DateOfRegistration = new DateTime(2024, 12, 8, 13, 33, 10, 742, DateTimeKind.Utc).AddTicks(5260),
            ...
            modelBuilder.Entity("PropertyReservationWeb.Domain.Models.Review", b =>
                {
                    b.HasOne("PropertyReservationWeb.Domain.Models.RentalRequest", "Rental_request")
                        .WithMany("Review")
                        .HasForeignKey("IdNeedRentalRequest")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Rental_request");
                });
